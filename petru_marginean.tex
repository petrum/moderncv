...
\maketitle
\section{Profile}
\cvlistitem{Expert C++ developer with +30 years of experience}
...
\cvlistitem{Proficient in Python/Pandas, Perl, Q/kdb+, Sybase/SQL/mysql, Excel/VBA, Java/Kotlin, PHP, C\#}
\cvlistitem{Worked in the financial industry for +20 years}
...
\cventry{Aug 2011- Today}{IT Director, Execution Services}{Laurion Capital Management}{New York City}{}
        {The main developer of the C++ execution system used for trading for Equities, Futures by +20 traders. 
          ...
          Wrote misc kdb+ feedhandlers for persisting realtime market data from US/China markets using Vela/Reuters.
...
\cvlanguage{Ding}{Raspberry Pi}{Using SDR and reverse engineering you hack your wireless doorbell and you control it remotely from
  your smartphone}
